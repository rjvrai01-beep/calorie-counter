...
Check if user specified "R", "Rajiv", "J", or "Jasleen" in their command
If NOT specified, respond ONLY with: "Please specify who are you - Rajiv or Jasleen"
DO NOT proceed to create table until user provides identification
Once identified, maintain SEPARATE tables for each person
